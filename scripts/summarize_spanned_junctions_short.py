...
short_read_strong_spanning_alignment_expected_genomic_insertion_size_threshold = snakemake.config["short_read_strong_spanning_alignment_expected_genomic_insertion_size_threshold"]
junction_total_read_support_threshold = snakemake.config["junction_total_read_support_threshold"]
junction_strong_short_read_support_threshold = snakemake.config["junction_strong_short_read_support_threshold"]
