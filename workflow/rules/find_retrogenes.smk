...
rule find_retrogene_alignments_long:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/find_retrogene_alignments_long/{ref}.{sample}.log",
    shell:
...
rule subset_transcriptome_bam:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/subset_transcriptome_bam/{ref}.{sample}.log",
    script:
...
rule subset_genome_bam:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/subset_genome_bam/{ref}.{sample}.log",
    shell:
...
rule add_geneid_to_subset_sams:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/add_geneid_to_subset_sams/{ref}.{sample}.log",
    script:
...
rule sort_genome_geneid_sam:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/sort_genome_geneid_sam/{ref}.{sample}.log",
    shell:
...
rule sort_transcriptome_geneid_sam:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/sort_transcriptome_geneid_sam/{ref}.{sample}.log",
    shell:
        "sort -k1,1 {input} > {output}"
...
rule find_shortreads_alignments:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/find_shortreads_alignments/{ref}.{sample}.log",
    shell:
