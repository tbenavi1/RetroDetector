rule final_genome_alignments:
    ...
    output:
        temp(
            "results/retrogenes/{ref}/{sample}/long/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.retrogenes.supportingalignments.genome.sam"
        ),
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/final_genome_alignments/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.log",
    script:
...
rule bam_final_genome_alignments:
    ...
    output:
        temp(
            "results/retrogenes/{ref}/{sample}/long/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.retrogenes.supportingalignments.genome.bam"
        ),
    threads: 32
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/bam_final_genome_alignments/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.log",
    shell:
...
rule sort_final_genome_alignments:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/sort_final_genome_alignments/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.log",
    shell:
...
rule index_final_genome_alignments:
    ...
    conda:
        "../envs/samtools.yaml"
    log:
        "logs/index_final_genome_alignments/{ref}.{sample}.junctover{junction_overhang}.insertthresh{insertions_threshold}.totalsupport{junction_total_read_support_threshold}.log",
    shell:
